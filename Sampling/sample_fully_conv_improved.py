...
def sample_latent_space_var(vae_encoder, train_data, test_data, id, dataset_min, dataset_max, dataset_type): 
    ...
    np.save("/fast/gmooers/gmooers_git/CBRAIN-CAM/MAPS/DYAMOND_VAEs/model_graphs/latent_space/SPCAM/Big_4K_With_FLux_SPCAM_Full_1024D_Latent_Space__{}".format(id), z_test)
    ...
    np.save("/fast/gmooers/gmooers_git/CBRAIN-CAM/MAPS/DYAMOND_VAEs/model_graphs/latent_space/Scree/Big_4K_With_Flux_SPCAM_3D_PCA_Latent_Space__{}".format(id), z_test_pca)
